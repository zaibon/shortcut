...
func IndexPage(data IndexPageData) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"flex flex-col bg-gray-100 items-center h-screen\"><div class=\"container mx-auto mt-10 p-4 max-w-md bg-white shadow-md rounded-lg mb-4\"><h1 class=\"text-2xl font-bold mb-4 text-center\">ShortCut <span class=\"text-gray-400 text-sm mb-4 text-center\">your friendly url shortener</span></h1>")
